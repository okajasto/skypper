...
var Skypper = (function() {
	...
	function withImageData(imageSrc, callback) {
		...
		img.onload = function() {
			...
			var imageData = ctx.getImageData(0, 0, IMAGE_SIZE, IMAGE_SIZE);
			callback(imageData);
		}

		// Load the image (triggers the onload function above when complete)
		img.src = imageSrc;
	}

	// Map each of the image input pixels into a colorMap value (Skype emoticon!)
	...
	// Convert hex ('ffffff') into RGB ({ r: 255, g: 255, b: 255 })
